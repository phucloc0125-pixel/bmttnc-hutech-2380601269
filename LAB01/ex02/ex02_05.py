...
# Tính số giờ làm vượt chuẩn và giờ tính chuẩn
gio_vuot_chuan = max(0, so_gio_lam - gio_tieu_chuan)
gio_tinh_chuan = min(so_gio_lam, gio_tieu_chuan)

# Tính tổng thu nhập
thuc_linh = (gio_tinh_chuan * luong_gio) + (gio_vuot_chuan * luong_gio * 1.5)
